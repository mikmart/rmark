...
describe("md_list_type()", {
  ...
  it("is missing for inapplicable nodes", {
    expect_equal(md_list_type(text_node), NA_character_)
  })
})
...
describe("md_list_delim()", {
  ...
  it("is missing for inapplicable nodes", {
    expect_equal(md_list_delim(text_node), NA_character_)
  })
})
...
describe("md_list_start()", {
  ...
  it("is missing for inapplicable nodes", {
    expect_equal(md_list_start(text_node), NA_integer_)
  })
})
...
describe("md_list_tight()", {
  ...
  it("signals useful errors", {
    expect_snapshot(md_list_tight(text_node) <- TRUE, error = TRUE)
  })
  it("is missing for inapplicable nodes", {
    expect_equal(md_list_tight(text_node), NA)
  })
})
